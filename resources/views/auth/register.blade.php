    ...
    <x-auth.auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-auth.text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus />
            ...
            <div class="mt-4">
                ...
                <x-auth.text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required />
